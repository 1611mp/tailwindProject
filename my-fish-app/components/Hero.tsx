...
export default function HeroSection() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-700 via-blue-400 to-sky-300">
      ...
      {/* Hero Section Content (keep your current layout) */}
      <main>
  ...
  <a
    href="#freshwater"
    className="rounded-md bg-sky-800 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-sky-500"
  >
    Explore Freshwater
  </a>
  <a
    href="#marine"
    className="rounded-md bg-teal-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-teal-500"
  >
    Explore Marine
  </a>
  <a
    href="#terrarium"
    className="rounded-md bg-orange-500 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-orange-400"
  >
    Explore Terrarium
  </a>
</div>
